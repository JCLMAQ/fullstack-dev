...
import { StoryOrderByWithAggregationInputObjectSchema as StoryOrderByWithAggregationInputObjectSchema } from './objects/StoryOrderByWithAggregationInput.schema';
import { StoryScalarWhereWithAggregatesInputObjectSchema as StoryScalarWhereWithAggregatesInputObjectSchema } from './objects/StoryScalarWhereWithAggregatesInput.schema';
...
export const StoryGroupBySchema: z.ZodType<Prisma.StoryGroupByArgs> = z.object({ where: StoryWhereInputObjectSchema.optional(), orderBy: z.union([StoryOrderByWithAggregationInputObjectSchema, StoryOrderByWithAggregationInputObjectSchema.array()]).optional(), having: StoryScalarWhereWithAggregatesInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), by: z.array(StoryScalarFieldEnumSchema), _count: z.union([ z.literal(true), StoryCountAggregateInputObjectSchema ]).optional(), _min: StoryMinAggregateInputObjectSchema.optional(), _max: StoryMaxAggregateInputObjectSchema.optional(), _avg: StoryAvgAggregateInputObjectSchema.optional(), _sum: StorySumAggregateInputObjectSchema.optional() }).strict() as unknown as z.ZodType<Prisma.StoryGroupByArgs>;

export const StoryGroupByZodSchema = z.object({ where: StoryWhereInputObjectSchema.optional(), orderBy: z.union([StoryOrderByWithAggregationInputObjectSchema, StoryOrderByWithAggregationInputObjectSchema.array()]).optional(), having: StoryScalarWhereWithAggregatesInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), by: z.array(StoryScalarFieldEnumSchema), _count: z.union([ z.literal(true), StoryCountAggregateInputObjectSchema ]).optional(), _min: StoryMinAggregateInputObjectSchema.optional(), _max: StoryMaxAggregateInputObjectSchema.optional(), _avg: StoryAvgAggregateInputObjectSchema.optional(), _sum: StorySumAggregateInputObjectSchema.optional() }).strict();