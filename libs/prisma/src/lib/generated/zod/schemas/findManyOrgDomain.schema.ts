...
export const OrgDomainFindManySelectSchema: z.ZodType<Prisma.OrgDomainSelect> = z.object({
...
export const OrgDomainFindManySelectZodSchema = z.object({
    id: z.boolean().optional(),
    createdAt: z.boolean().optional(),
    updatedAt: z.boolean().optional(),
    published: z.boolean().optional(),
...
export const OrgDomainFindManySchema: z.ZodType<Prisma.OrgDomainFindManyArgs> = z.object({ select: OrgDomainFindManySelectSchema.optional(), include: z.lazy(() => OrgDomainIncludeObjectSchema.optional()), orderBy: z.union([OrgDomainOrderByWithRelationInputObjectSchema, OrgDomainOrderByWithRelationInputObjectSchema.array()]).optional(), where: OrgDomainWhereInputObjectSchema.optional(), cursor: OrgDomainWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([OrgDomainScalarFieldEnumSchema, OrgDomainScalarFieldEnumSchema.array()]).optional() }).strict() as unknown as z.ZodType<Prisma.OrgDomainFindManyArgs>;

export const OrgDomainFindManyZodSchema = z.object({ select: OrgDomainFindManySelectSchema.optional(), include: z.lazy(() => OrgDomainIncludeObjectSchema.optional()), orderBy: z.union([OrgDomainOrderByWithRelationInputObjectSchema, OrgDomainOrderByWithRelationInputObjectSchema.array()]).optional(), where: OrgDomainWhereInputObjectSchema.optional(), cursor: OrgDomainWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([OrgDomainScalarFieldEnumSchema, OrgDomainScalarFieldEnumSchema.array()]).optional() }).strict();