...
export const RefreshTokenUpsertOneSchema: z.ZodType<Prisma.RefreshTokenUpsertArgs> = z.object({ select: RefreshTokenSelectObjectSchema.optional(),  where: RefreshTokenWhereUniqueInputObjectSchema, create: z.union([ RefreshTokenCreateInputObjectSchema, RefreshTokenUncheckedCreateInputObjectSchema ]), update: z.union([ RefreshTokenUpdateInputObjectSchema, RefreshTokenUncheckedUpdateInputObjectSchema ]) }).strict() as unknown as z.ZodType<Prisma.RefreshTokenUpsertArgs>;

export const RefreshTokenUpsertOneZodSchema = z.object({ select: RefreshTokenSelectObjectSchema.optional(),  where: RefreshTokenWhereUniqueInputObjectSchema, create: z.union([ RefreshTokenCreateInputObjectSchema, RefreshTokenUncheckedCreateInputObjectSchema ]), update: z.union([ RefreshTokenUpdateInputObjectSchema, RefreshTokenUncheckedUpdateInputObjectSchema ]) }).strict();