...
export const StoryFindManySelectSchema: z.ZodType<Prisma.StorySelect> = z.object({
...
export const StoryFindManySelectZodSchema = z.object({
    id: z.boolean().optional(),
    numSeq: z.boolean().optional(),
    createdAt: z.boolean().optional(),
    updatedAt: z.boolean().optional(),
...
export const StoryFindManySchema: z.ZodType<Prisma.StoryFindManyArgs> = z.object({ select: StoryFindManySelectSchema.optional(), include: z.lazy(() => StoryIncludeObjectSchema.optional()), orderBy: z.union([StoryOrderByWithRelationInputObjectSchema, StoryOrderByWithRelationInputObjectSchema.array()]).optional(), where: StoryWhereInputObjectSchema.optional(), cursor: StoryWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([StoryScalarFieldEnumSchema, StoryScalarFieldEnumSchema.array()]).optional() }).strict() as unknown as z.ZodType<Prisma.StoryFindManyArgs>;

export const StoryFindManyZodSchema = z.object({ select: StoryFindManySelectSchema.optional(), include: z.lazy(() => StoryIncludeObjectSchema.optional()), orderBy: z.union([StoryOrderByWithRelationInputObjectSchema, StoryOrderByWithRelationInputObjectSchema.array()]).optional(), where: StoryWhereInputObjectSchema.optional(), cursor: StoryWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([StoryScalarFieldEnumSchema, StoryScalarFieldEnumSchema.array()]).optional() }).strict();