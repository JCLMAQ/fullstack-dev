...
export const ChangesTrackingFindFirstSelectSchema: z.ZodType<Prisma.ChangesTrackingSelect> = z.object({
...
export const ChangesTrackingFindFirstSelectZodSchema = z.object({
    id: z.boolean().optional(),
    createdAt: z.boolean().optional(),
    updatedAt: z.boolean().optional(),
    published: z.boolean().optional(),
...
export const ChangesTrackingFindFirstSchema: z.ZodType<Prisma.ChangesTrackingFindFirstArgs> = z.object({ select: ChangesTrackingFindFirstSelectSchema.optional(), include: z.lazy(() => ChangesTrackingIncludeObjectSchema.optional()), orderBy: z.union([ChangesTrackingOrderByWithRelationInputObjectSchema, ChangesTrackingOrderByWithRelationInputObjectSchema.array()]).optional(), where: ChangesTrackingWhereInputObjectSchema.optional(), cursor: ChangesTrackingWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([ChangesTrackingScalarFieldEnumSchema, ChangesTrackingScalarFieldEnumSchema.array()]).optional() }).strict() as unknown as z.ZodType<Prisma.ChangesTrackingFindFirstArgs>;

export const ChangesTrackingFindFirstZodSchema = z.object({ select: ChangesTrackingFindFirstSelectSchema.optional(), include: z.lazy(() => ChangesTrackingIncludeObjectSchema.optional()), orderBy: z.union([ChangesTrackingOrderByWithRelationInputObjectSchema, ChangesTrackingOrderByWithRelationInputObjectSchema.array()]).optional(), where: ChangesTrackingWhereInputObjectSchema.optional(), cursor: ChangesTrackingWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([ChangesTrackingScalarFieldEnumSchema, ChangesTrackingScalarFieldEnumSchema.array()]).optional() }).strict();