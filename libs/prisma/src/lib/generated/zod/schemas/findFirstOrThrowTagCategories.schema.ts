...
export const TagCategoriesFindFirstOrThrowSelectSchema: z.ZodType<Prisma.TagCategoriesSelect> = z.object({
...
export const TagCategoriesFindFirstOrThrowSelectZodSchema = z.object({
    id: z.boolean().optional(),
    createdAt: z.boolean().optional(),
    updatedAt: z.boolean().optional(),
    published: z.boolean().optional(),
...
export const TagCategoriesFindFirstOrThrowSchema: z.ZodType<Prisma.TagCategoriesFindFirstOrThrowArgs> = z.object({ select: TagCategoriesFindFirstOrThrowSelectSchema.optional(), include: z.lazy(() => TagCategoriesIncludeObjectSchema.optional()), orderBy: z.union([TagCategoriesOrderByWithRelationInputObjectSchema, TagCategoriesOrderByWithRelationInputObjectSchema.array()]).optional(), where: TagCategoriesWhereInputObjectSchema.optional(), cursor: TagCategoriesWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([TagCategoriesScalarFieldEnumSchema, TagCategoriesScalarFieldEnumSchema.array()]).optional() }).strict() as unknown as z.ZodType<Prisma.TagCategoriesFindFirstOrThrowArgs>;

export const TagCategoriesFindFirstOrThrowZodSchema = z.object({ select: TagCategoriesFindFirstOrThrowSelectSchema.optional(), include: z.lazy(() => TagCategoriesIncludeObjectSchema.optional()), orderBy: z.union([TagCategoriesOrderByWithRelationInputObjectSchema, TagCategoriesOrderByWithRelationInputObjectSchema.array()]).optional(), where: TagCategoriesWhereInputObjectSchema.optional(), cursor: TagCategoriesWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([TagCategoriesScalarFieldEnumSchema, TagCategoriesScalarFieldEnumSchema.array()]).optional() }).strict();