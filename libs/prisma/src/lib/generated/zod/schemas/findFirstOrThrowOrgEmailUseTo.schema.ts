...
export const OrgEmailUseToFindFirstOrThrowSelectSchema: z.ZodType<Prisma.OrgEmailUseToSelect> = z.object({
...
export const OrgEmailUseToFindFirstOrThrowSelectZodSchema = z.object({
    id: z.boolean().optional(),
    createdAt: z.boolean().optional(),
    updatedAt: z.boolean().optional(),
    published: z.boolean().optional(),
...
export const OrgEmailUseToFindFirstOrThrowSchema: z.ZodType<Prisma.OrgEmailUseToFindFirstOrThrowArgs> = z.object({ select: OrgEmailUseToFindFirstOrThrowSelectSchema.optional(), include: z.lazy(() => OrgEmailUseToIncludeObjectSchema.optional()), orderBy: z.union([OrgEmailUseToOrderByWithRelationInputObjectSchema, OrgEmailUseToOrderByWithRelationInputObjectSchema.array()]).optional(), where: OrgEmailUseToWhereInputObjectSchema.optional(), cursor: OrgEmailUseToWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([OrgEmailUseToScalarFieldEnumSchema, OrgEmailUseToScalarFieldEnumSchema.array()]).optional() }).strict() as unknown as z.ZodType<Prisma.OrgEmailUseToFindFirstOrThrowArgs>;

export const OrgEmailUseToFindFirstOrThrowZodSchema = z.object({ select: OrgEmailUseToFindFirstOrThrowSelectSchema.optional(), include: z.lazy(() => OrgEmailUseToIncludeObjectSchema.optional()), orderBy: z.union([OrgEmailUseToOrderByWithRelationInputObjectSchema, OrgEmailUseToOrderByWithRelationInputObjectSchema.array()]).optional(), where: OrgEmailUseToWhereInputObjectSchema.optional(), cursor: OrgEmailUseToWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([OrgEmailUseToScalarFieldEnumSchema, OrgEmailUseToScalarFieldEnumSchema.array()]).optional() }).strict();