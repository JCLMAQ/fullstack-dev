...
export const UserPostLikeLinkFindManySelectSchema: z.ZodType<Prisma.UserPostLikeLinkSelect> = z.object({
...
export const UserPostLikeLinkFindManySelectZodSchema = z.object({
    user_id: z.boolean().optional(),
    user: z.boolean().optional(),
    post_id: z.boolean().optional(),
    post: z.boolean().optional(),
...
export const UserPostLikeLinkFindManySchema: z.ZodType<Prisma.UserPostLikeLinkFindManyArgs> = z.object({ select: UserPostLikeLinkFindManySelectSchema.optional(), include: z.lazy(() => UserPostLikeLinkIncludeObjectSchema.optional()), orderBy: z.union([UserPostLikeLinkOrderByWithRelationInputObjectSchema, UserPostLikeLinkOrderByWithRelationInputObjectSchema.array()]).optional(), where: UserPostLikeLinkWhereInputObjectSchema.optional(), cursor: UserPostLikeLinkWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([UserPostLikeLinkScalarFieldEnumSchema, UserPostLikeLinkScalarFieldEnumSchema.array()]).optional() }).strict() as unknown as z.ZodType<Prisma.UserPostLikeLinkFindManyArgs>;

export const UserPostLikeLinkFindManyZodSchema = z.object({ select: UserPostLikeLinkFindManySelectSchema.optional(), include: z.lazy(() => UserPostLikeLinkIncludeObjectSchema.optional()), orderBy: z.union([UserPostLikeLinkOrderByWithRelationInputObjectSchema, UserPostLikeLinkOrderByWithRelationInputObjectSchema.array()]).optional(), where: UserPostLikeLinkWhereInputObjectSchema.optional(), cursor: UserPostLikeLinkWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([UserPostLikeLinkScalarFieldEnumSchema, UserPostLikeLinkScalarFieldEnumSchema.array()]).optional() }).strict();