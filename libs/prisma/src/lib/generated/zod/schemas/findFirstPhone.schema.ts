...
export const PhoneFindFirstSelectSchema: z.ZodType<Prisma.PhoneSelect> = z.object({
...
export const PhoneFindFirstSelectZodSchema = z.object({
    id: z.boolean().optional(),
    createdAt: z.boolean().optional(),
    updatedAt: z.boolean().optional(),
    user: z.boolean().optional(),
...
export const PhoneFindFirstSchema: z.ZodType<Prisma.PhoneFindFirstArgs> = z.object({ select: PhoneFindFirstSelectSchema.optional(), include: z.lazy(() => PhoneIncludeObjectSchema.optional()), orderBy: z.union([PhoneOrderByWithRelationInputObjectSchema, PhoneOrderByWithRelationInputObjectSchema.array()]).optional(), where: PhoneWhereInputObjectSchema.optional(), cursor: PhoneWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([PhoneScalarFieldEnumSchema, PhoneScalarFieldEnumSchema.array()]).optional() }).strict() as unknown as z.ZodType<Prisma.PhoneFindFirstArgs>;

export const PhoneFindFirstZodSchema = z.object({ select: PhoneFindFirstSelectSchema.optional(), include: z.lazy(() => PhoneIncludeObjectSchema.optional()), orderBy: z.union([PhoneOrderByWithRelationInputObjectSchema, PhoneOrderByWithRelationInputObjectSchema.array()]).optional(), where: PhoneWhereInputObjectSchema.optional(), cursor: PhoneWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([PhoneScalarFieldEnumSchema, PhoneScalarFieldEnumSchema.array()]).optional() }).strict();