...
export const OrgEmailFindFirstOrThrowSelectSchema: z.ZodType<Prisma.OrgEmailSelect> = z.object({
...
export const OrgEmailFindFirstOrThrowSelectZodSchema = z.object({
    id: z.boolean().optional(),
    createdAt: z.boolean().optional(),
    updatedAt: z.boolean().optional(),
    published: z.boolean().optional(),
...
export const OrgEmailFindFirstOrThrowSchema: z.ZodType<Prisma.OrgEmailFindFirstOrThrowArgs> = z.object({ select: OrgEmailFindFirstOrThrowSelectSchema.optional(), include: z.lazy(() => OrgEmailIncludeObjectSchema.optional()), orderBy: z.union([OrgEmailOrderByWithRelationInputObjectSchema, OrgEmailOrderByWithRelationInputObjectSchema.array()]).optional(), where: OrgEmailWhereInputObjectSchema.optional(), cursor: OrgEmailWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([OrgEmailScalarFieldEnumSchema, OrgEmailScalarFieldEnumSchema.array()]).optional() }).strict() as unknown as z.ZodType<Prisma.OrgEmailFindFirstOrThrowArgs>;

export const OrgEmailFindFirstOrThrowZodSchema = z.object({ select: OrgEmailFindFirstOrThrowSelectSchema.optional(), include: z.lazy(() => OrgEmailIncludeObjectSchema.optional()), orderBy: z.union([OrgEmailOrderByWithRelationInputObjectSchema, OrgEmailOrderByWithRelationInputObjectSchema.array()]).optional(), where: OrgEmailWhereInputObjectSchema.optional(), cursor: OrgEmailWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([OrgEmailScalarFieldEnumSchema, OrgEmailScalarFieldEnumSchema.array()]).optional() }).strict();