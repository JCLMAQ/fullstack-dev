...
export const TagTranslateFindFirstSelectSchema: z.ZodType<Prisma.TagTranslateSelect> = z.object({
...
export const TagTranslateFindFirstSelectZodSchema = z.object({
    id: z.boolean().optional(),
    createdAt: z.boolean().optional(),
    updatedAt: z.boolean().optional(),
    language: z.boolean().optional(),
