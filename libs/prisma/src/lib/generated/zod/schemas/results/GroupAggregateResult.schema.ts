...
export const GroupAggregateResultSchema = z.object({  _count: z.union([z.number(), z.object({
  ...
  _sum: z.object({
    ...
    orderGroup: z.number().nullable().optional()
  }).nullable().optional(),
  _avg: z.object({
    id: z.number().nullable().optional(),
    isDeleted: z.number().nullable().optional(),
  ...
  _min: z.object({
    ...
    orderGroup: z.number().int().nullable().optional(),
