...
export const TaskAggregateResultSchema = z.object({  _count: z.union([z.number(), z.object({
    ...
    orderTask: z.number().optional(),
    title: z.number().optional(),
    content: z.number().optional(),
    taskState: z.number().optional(),
    mainTaskId: z.number().optional(),
  ...
  _sum: z.object({
    ...
    orderTask: z.number().nullable().optional()
  }).nullable().optional(),
  _avg: z.object({
    numSeq: z.number().nullable().optional(),
    isDeleted: z.number().nullable().optional(),
  ...
  _min: z.object({
    ...
    orderTask: z.number().int().nullable().optional(),
    title: z.string().nullable().optional(),
    content: z.string().nullable().optional(),
    taskState: z.unknown().nullable().optional(),
