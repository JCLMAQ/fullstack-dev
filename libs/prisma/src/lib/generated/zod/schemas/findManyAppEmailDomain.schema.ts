...
export const AppEmailDomainFindManySelectSchema: z.ZodType<Prisma.AppEmailDomainSelect> = z.object({
...
export const AppEmailDomainFindManySelectZodSchema = z.object({
    id: z.boolean().optional(),
    createdAt: z.boolean().optional(),
    updatedAt: z.boolean().optional(),
    published: z.boolean().optional(),
