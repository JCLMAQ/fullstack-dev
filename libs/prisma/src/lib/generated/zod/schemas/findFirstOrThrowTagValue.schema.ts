...
export const TagValueFindFirstOrThrowSelectSchema: z.ZodType<Prisma.TagValueSelect> = z.object({
...
export const TagValueFindFirstOrThrowSelectZodSchema = z.object({
    id: z.boolean().optional(),
    createdAt: z.boolean().optional(),
    updatedAt: z.boolean().optional(),
    published: z.boolean().optional(),
...
export const TagValueFindFirstOrThrowSchema: z.ZodType<Prisma.TagValueFindFirstOrThrowArgs> = z.object({ select: TagValueFindFirstOrThrowSelectSchema.optional(), include: z.lazy(() => TagValueIncludeObjectSchema.optional()), orderBy: z.union([TagValueOrderByWithRelationInputObjectSchema, TagValueOrderByWithRelationInputObjectSchema.array()]).optional(), where: TagValueWhereInputObjectSchema.optional(), cursor: TagValueWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([TagValueScalarFieldEnumSchema, TagValueScalarFieldEnumSchema.array()]).optional() }).strict() as unknown as z.ZodType<Prisma.TagValueFindFirstOrThrowArgs>;

export const TagValueFindFirstOrThrowZodSchema = z.object({ select: TagValueFindFirstOrThrowSelectSchema.optional(), include: z.lazy(() => TagValueIncludeObjectSchema.optional()), orderBy: z.union([TagValueOrderByWithRelationInputObjectSchema, TagValueOrderByWithRelationInputObjectSchema.array()]).optional(), where: TagValueWhereInputObjectSchema.optional(), cursor: TagValueWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([TagValueScalarFieldEnumSchema, TagValueScalarFieldEnumSchema.array()]).optional() }).strict();