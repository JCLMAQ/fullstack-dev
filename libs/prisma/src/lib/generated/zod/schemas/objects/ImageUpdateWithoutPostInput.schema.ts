...
import { UserUpdateOneWithoutUploadedImagesNestedInputObjectSchema as UserUpdateOneWithoutUploadedImagesNestedInputObjectSchema } from './UserUpdateOneWithoutUploadedImagesNestedInput.schema';
import { OrganizationUpdateOneWithoutImagesNestedInputObjectSchema as OrganizationUpdateOneWithoutImagesNestedInputObjectSchema } from './OrganizationUpdateOneWithoutImagesNestedInput.schema';
import { UserUpdateOneWithoutProfileImagesNestedInputObjectSchema as UserUpdateOneWithoutProfileImagesNestedInputObjectSchema } from './UserUpdateOneWithoutProfileImagesNestedInput.schema';
import { StoryUpdateOneWithoutImagesNestedInputObjectSchema as StoryUpdateOneWithoutImagesNestedInputObjectSchema } from './StoryUpdateOneWithoutImagesNestedInput.schema'
...
const makeSchema = () => z.object({
  ...
  uploadedBy: z.lazy(() => UserUpdateOneWithoutUploadedImagesNestedInputObjectSchema).optional(),
  org: z.lazy(() => OrganizationUpdateOneWithoutImagesNestedInputObjectSchema).optional(),
  profileUser: z.lazy(() => UserUpdateOneWithoutProfileImagesNestedInputObjectSchema).optional(),
  story: z.lazy(() => StoryUpdateOneWithoutImagesNestedInputObjectSchema).optional()
}).strict();
export const ImageUpdateWithoutPostInputObjectSchema: z.ZodType<Prisma.ImageUpdateWithoutPostInput> = makeSchema() as unknown as z.ZodType<Prisma.ImageUpdateWithoutPostInput>;
export const ImageUpdateWithoutPostInputObjectZodSchema = makeSchema();
