...
const makeSchema = () => z.object({
  ...
  orderCategory: z.union([z.number().int(), z.lazy(() => IntFieldUpdateOperationsInputObjectSchema)]).optional(),
  name: z.union([z.string(), z.lazy(() => StringFieldUpdateOperationsInputObjectSchema)]).optional()
}).strict();
export const CategoryUncheckedUpdateManyWithoutPostsInputObjectSchema: z.ZodType<Prisma.CategoryUncheckedUpdateManyWithoutPostsInput> = makeSchema() as unknown as z.ZodType<Prisma.CategoryUncheckedUpdateManyWithoutPostsInput>;
export const CategoryUncheckedUpdateManyWithoutPostsInputObjectZodSchema = makeSchema();
