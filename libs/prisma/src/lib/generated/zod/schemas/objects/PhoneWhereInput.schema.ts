...
const phonewhereinputSchema = z.object({
  AND: z.union([z.lazy(() => PhoneWhereInputObjectSchema), z.lazy(() => PhoneWhereInputObjectSchema).array()]).optional(),
  OR: z.lazy(() => PhoneWhereInputObjectSchema).array().optional(),
  NOT: z.union([z.lazy(() => PhoneWhereInputObjectSchema), z.lazy(() => PhoneWhereInputObjectSchema).array()]).optional(),
...
export const PhoneWhereInputObjectSchema: z.ZodType<Prisma.PhoneWhereInput> = phonewhereinputSchema as unknown as z.ZodType<Prisma.PhoneWhereInput>;
export const PhoneWhereInputObjectZodSchema = phonewhereinputSchema;
