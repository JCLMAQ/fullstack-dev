...
import { UserUpdateOneRequiredWithoutTokensNestedInputObjectSchema as UserUpdateOneRequiredWithoutTokensNestedInputObjectSchema } from './UserUpdateOneRequiredWithoutTokensNestedInput.schema'
...
const makeSchema = () => z.object({
  ...
  user: z.lazy(() => UserUpdateOneRequiredWithoutTokensNestedInputObjectSchema).optional()
}).strict();
export const TokenUpdateInputObjectSchema: z.ZodType<Prisma.TokenUpdateInput> = makeSchema() as unknown as z.ZodType<Prisma.TokenUpdateInput>;
export const TokenUpdateInputObjectZodSchema = makeSchema();
