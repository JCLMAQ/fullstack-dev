...
export const WordFindManySelectSchema: z.ZodType<Prisma.WordSelect> = z.object({
...
export const WordFindManySelectZodSchema = z.object({
    id: z.boolean().optional(),
    createdAt: z.boolean().optional(),
    updatedAt: z.boolean().optional(),
    published: z.boolean().optional(),
...
export const WordFindManySchema: z.ZodType<Prisma.WordFindManyArgs> = z.object({ select: WordFindManySelectSchema.optional(), include: z.lazy(() => WordIncludeObjectSchema.optional()), orderBy: z.union([WordOrderByWithRelationInputObjectSchema, WordOrderByWithRelationInputObjectSchema.array()]).optional(), where: WordWhereInputObjectSchema.optional(), cursor: WordWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([WordScalarFieldEnumSchema, WordScalarFieldEnumSchema.array()]).optional() }).strict() as unknown as z.ZodType<Prisma.WordFindManyArgs>;

export const WordFindManyZodSchema = z.object({ select: WordFindManySelectSchema.optional(), include: z.lazy(() => WordIncludeObjectSchema.optional()), orderBy: z.union([WordOrderByWithRelationInputObjectSchema, WordOrderByWithRelationInputObjectSchema.array()]).optional(), where: WordWhereInputObjectSchema.optional(), cursor: WordWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([WordScalarFieldEnumSchema, WordScalarFieldEnumSchema.array()]).optional() }).strict();