...
import { FileResponse } from './files-jcm.controller';
...
// Allow only images
export const imageFileFilter = (req: Request, file: FileResponse, callback: (arg0: HttpException | null, arg1: boolean) => void) => {
...
export const fileFileFilter = (req: Request, file: FileResponse, callback: (arg0: HttpException | null, arg1: boolean) => void) => {
...
export const fileMaxSize = (req: Request, file: any, callback: (arg0: any, arg1: string) => void) => {
  ...
  const valueCallBack = fileMaxSize || '10485760';
  callback(null, valueCallBack);
};
...
export const imageMaxSize = (callback: (arg0: string) => void) => {
  ...
  const valueCallBack = imageMaxSize || '5242880';
