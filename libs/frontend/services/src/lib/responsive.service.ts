...
sideNavWidth = computed(() => (  this.isMenuBarOpen() ? (this.isCollapsed() ? '65px' : '250px') : '0px' ));
// sideNavWidth = computed(() => (
//   this.modeSideNav() === 'over' ? '0px' : (this.isMenuBarOpen() ? (this.isCollapsed() ? '65px' : '250px') : '0px')
// ));
styleMarginLeft = computed(() => (this.modeSideNav() === 'over' ? '0px' : (this.isMenuBarOpen() ? (this.isCollapsed() ? '65px' : '250px') : '0px')));
